...
function About() {
    return (
        <Container style={{ marginTop: "35vh", textAlign: "left" }} >
            ...
            <h5 style={{ fontWeight: "300", marginTop: "2.8rem", fontSize: "16px" }}>Coding on ReactJS and dreaming on ReactJS. Helping companies build complex web<br /> applications serving 100,000+ users with modern technologies. <br /></h5>
