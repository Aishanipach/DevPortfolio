...
function About() {
    return (
        <Container style={{ marginTop: "35vh", textAlign: "left" }} >
            ...
            <h5 style={{ fontWeight: "300", marginTop: "2.8rem", fontSize: "16px" }}>Coding on ReactJS and dreaming on ReactJS. Specializing in designning, building<br /> shipping and scaling applications serving 100,000+ users with blazing fast- efficiency using modern technologies. <br /></h5>
