...
function About() {
    return (
        <Container style={{ marginTop: "35vh", textAlign: "left" }} >
            ...
            <h5 style={{ fontWeight: "300", marginTop: "2.8rem", fontSize: "16px" }}>Creating web experiences to cater your UI needs. Coding since class 11th and<br /> I have always been fascinated by the fact that there is logic behind everything.<br /></h5>
