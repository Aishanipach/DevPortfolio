...
function About() {
    return (
        <Container style={{ marginTop: "35vh", textAlign: "left" }} >
            ...
            <h5 style={{ fontWeight: "300", marginTop: "2.8rem", fontSize: "16px" }}>Coding on ReactJS and dreaming on ReactJS. Help companies to<br /> build complex web applications serving 100,000+ users with moden technology.<br /></h5>
